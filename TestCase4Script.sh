java AggregationServer testing 4 &
...
java ContentServer testing 4 &
java GETClient testing 4
...
DIFF=$(diff --strip-trailing-cr Testing/TestCase4Output.txt Testing/TestCase4ExpectedOutput.txt)
if [ "$DIFF" = "" ]
then
